...
if __name__ == '__main__':
    ...
    img_name = r"D:\NCKU\Course\Digital Image Processing And Computer vision\HW3\Frequency Analysis and Restoration\data\Noisy.raw"  # 图像的路径
    img = read_image(img_name)    # 读入图像，cv2.IMREAD_GRAYSCALE:以灰度模式读入图像
